...
\textbf{\emph{Compound Value Type}} (CVT) is a special type in Freebase to represent complex structured data % where entries are described 
...
describing the Freebase structures or irrelevant to events %(e.g., \emph{food.recipe\_ingredient})
